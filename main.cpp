...
int main() {
    ...
    if (fin.good()) {
        ...
        cout << "3.  2nd temperature: " << temperatures.at(1) << endl;
        cout << "4.  3rd temperature: " << temperatures[2] << endl;
        ...
        // find an element
        double target = 79; // search target
        ...
        if (it != temperatures.end())
            cout << "\tFound, day#" << it - temperatures.begin() + 1 << "'s temperature is " << target << endl;
        else
            cout << " Not found.\n";
        ...
        cout << "14. The average temperature is: " << accumulate(temperatures.begin(), temperatures.end(), 0.0) 
                                                        / temperatures.size() << endl;
    ...
    if (fin.good()) {
        ...
        // <vector> objects can report their own size
        ...
        if (it != temperatures2.end())
            cout << "\tFound, day#" << it - temperatures2.begin() + 1 << "'s temperature is " << target << endl;
        else
            cout << " Not found.\n";
        ...
        cout << "14. The average temperature is: " << accumulate(temperatures2.begin(), temperatures2.end(), 0.0)
                                                     / temperatures2.size() << endl;
